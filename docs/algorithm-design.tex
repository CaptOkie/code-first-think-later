...
\begin{enumerate}
	\item[1.] Unven teams have been formed. The following figure, {\bf Figure 10} shows two groups, wherein the first group consists of a single Student, whereas the second group consists of four students, thus having a differential of 3.
\begin{figure}[H]
	\caption{Flow of Rule Application Between Individuals}
	\begin{center}
