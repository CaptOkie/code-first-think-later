...
\begin{enumerate}
	\item[1.] Groups that don't fall in the min/max range have been formed. The following figure, {\bf Figure 10} shows two groups, wherein the first group consists of a single Student, whereas the second group consists of four students, and where the min is 4 and the max is 6.
\begin{figure}[H]
