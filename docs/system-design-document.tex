...
\begin{table}[H]
	\caption{Prototype Subsystems} \tablelabel{proto-subsystems}
...
<<<<<<< HEAD
In this section, we give a list and description of each of the services that our subsystems offer. They will be divided into three separate tables - one for each of our subsystems. \sdlabel{storage}The following table encompasses all the services offered by the StorageSubsystem (\sdref{storage}). 
=======
