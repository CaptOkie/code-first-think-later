...
\begin{table}[H]
	\caption{ProfileOptionsService Classes (\ssref{profile-options})} 
	\begin{tabu} to \textwidth {l >{\it}l X}
	    \tableheader{}ID & Class Name & Description \\
...
\begin{table}[H]
	\caption{ProjectOptionsService Classes (\ssref{project-options})} 
	\begin{tabu} to \textwidth {l >{\it}l X}
	    \tableheader{}ID & Class Name & Description \\
...
\begin{table}[H]
	\caption{PPIDOptionsService Classes (\ssref{ppid-options})} 
	\begin{tabu} to \textwidth {l >{\it}l X}
	    \tableheader{}ID & Class Name & Description \\
