...
While it it, in the real world, possible for multiple people to share the same name, we want to make certain that the system can handle them appropriately. To do so, we added a unique identifier as the Primary Key, which is independent of the name itself. With this kind of system, it is impossible for duplicate accounts to exist.
>>>>>>> 15afa2a280d3376a40162761d7369129766c237d
