...
\begin{table}[H]
	...
	\begin{tabu} to \textwidth {l l l X}
		\tableheader{}Column & Type & Constraint & Description \\
		stu     & Integer & Primary Key, Foreign Key & References \textit{id} of the Students table. \\
		project & Text    & Primary Key, Foreign Key & \\
	\end{tabu}
\end{table}
...
\begin{tabu} to \textwidth {l >{\it}l X}
	...
	\cdlabel{realstudent}\cdref{realstudent} & RealStudent & \\
	\cdlabel{proxystudent}\cdref{proxystudent} & ProxyStudent & \\
	\cdlabel{studentstorage}\cdref{studentstorage} & StudentStorage & \\
	...
	\cdlabel{realadmin}\cdref{realadmin} & RealAdmin &\\
	\cdlabel{proxyadmin}\cdref{proxyadmin} & ProxyAdmin &\\
	\cdlabel{adminstorage}\cdref{adminstorage} & AdminStorage & \\
\end{tabu}
\end{table}
