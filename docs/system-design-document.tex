...
\noindent{}
The following table describes the service that is offered by the UserSubsystem (\sdref{user}).
...
\noindent{}
The following table describes the service that is offered by the ProfileSubsystem (\sdref{profile}).
...
\noindent{}
The following table describes the service that is offered by the ProjectSubsystem (\sdref{project}).
...
\noindent{}
The following table describes the service that is offered by the PPIDSubsystem (\sdref{ppid}).
...
The following table describes all the services that are offered by the StorageSubsystem (\sdref{storage}). 
