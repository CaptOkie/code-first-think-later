...
The following table, \tableref{user-option-classes}, describes each of the classes involved in the UserOptionsService service (\ssref{user-options}) as well as provide a unique indentifier for each.
\begin{table}[H]
...
\begin{figure}[H]
	...
	\caption{ProjectOptionsService Class Diagram (\ssref{user})}
