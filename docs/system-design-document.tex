...
To store the data for our system, a relational database is being used. The relational database used is SQLite. In the database, multiple tables are used to store related information together, such as a 
