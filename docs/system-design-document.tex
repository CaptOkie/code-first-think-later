...
In this section, we give a list and description of each of the services that our subsystems offer. They will be divided into three separate tables - one for each of our subsystems. \sdlabel{stu}The following table encompasses all the services offered by the Student Subsystem (\sdref{stu}). 
...
\sdlabel{admin}The following table showcases all the different services offered by the Administrator Subsytem (\sdref{admin}).
