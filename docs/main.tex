...
\hspace{1 pc}F-04-01 & \hspace{2 pc}There own values. \\
\hspace{1 pc}F-04-02 & \hspace{2 pc}What they are looking for. \\
...
\hspace{1 pc}F-07-01 & \hspace{2 pc}Set team size. \\
\hspace{1 pc}F-07-02 & \hspace{2 pc}Add students. \\
\hspace{1 pc}F-07-03 & \hspace{2 pc}Remove students. \\
\hspace{1 pc}F-07-04 & \hspace{2 pc}Project name. \\
F-08 & Administrators must be able to launch the PPID algorithm for a specific project. \\
\end{tabu}
\end{table}
