...
NF-03 & Implementation & must use the Qt framework for the user interface \\
...
NF-07 & Supportability & the system should be extensible to a client/server architecture \\
NF-08 & Legal & users will agree to a Terms of Service agreement \\
NF-09 & Interface & \\
NF-10 & Operations & a forum for users to report bugs \\
NF-11 & Packaging & will be available to download as a standalone executable \\
\end{tabu}
\end{table}
