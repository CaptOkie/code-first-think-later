...
\begin{center}
	\begin{tabu} to \textwidth {>{\it}l X}
	    ...
	    \begin{enumerate}[topsep=-1em]
		    \item The Student begins the cuPID process
		    \item The Student is presented with a menu from the system. Options of: joining a project, leaving a project, or editing their profile for a project
