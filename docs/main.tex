...
\caption{Control Object Data Dictionary}
	\begin{tabu} to \textwidth {>{\bf}l X[2]}
		...
		ManageEnrollmentControl & blah\\
		EditProfileControl & blah\\
		ManageProjectControl & blah\\
		CreateNewProjectControl & blah\\
		LaunchPPIDControl & blah\\
		InsufficientStudentsErrorControl & blah\\
		ViewPPIDResultsControl & blah\\
		ViewPPIDSummaryControl & blah\\
		ViewPPIDDetailsControl & blah\\
		EditProjectDetailsControl & blah\\
		EditProjectControl & blah\\
		JoinProjectControl & blah\\
		LeaveProjectControl & blah\\
		EditPersonalValuesControl & blah\\
		EditDesiredValuesControl & blah\\
		InvalidInputErrorControl & blah\\
		EditProjectNameControl & blah\\
		EditProjectDetailsControl & blah\\
		ProjectExistsErrorControl & blah\\
		EditGroupSizeControl & blah\\
		InvalidGroupSizeErrorControl & blah\\
		StorageControl & blah\\
		StorageErrorControl & blah\\
...
\caption{Boundary Object Data Dictionary}
	\begin{tabu} to \textwidth {>{\bf}l X[2]}
		...
		ProjectListNotice & blah\\
		EnrollmentOption & blah\\
		ProjectSelectionOption & blah\\
		ProfileOption & blah\\
		ManageOption & blah\\
		ProjectCreateNotice & blah\\
		ProjectDetailsForm & blah\\
		PPIDCompleteNotice & blah\\
		InsufficientStudentErrorNotice & blah\\
		ResultsOption & blah\\
		SummaryResultsNotice & blah\\
		DetailedResultsNotice & blah\\
		DetailsUpdatedNotice & blah\\
		ProjectDetailsForm & blah\\
		ProjectUpdateNotice & blah\\
		JoinCompleteNotice & blah\\
		LeaveCompleteNotice & blah\\
		UpdateCompleteNotice & blah\\
		InputOption & blah\\
		InvalidInputErrorNotice & blah\\
		EditProjectNameOption & blah\\
		ProjectNameUpdateNotice & blah\\
		ProjectExistsErrorNotice & blah\\
		EditGroupSizeOption & blah\\
		GroupSizeUpdateNotice & blah\\
		InvalidGroupSizeErrorNotice & blah\\
		StorageErrorNotice & blah\\
		StorageReadErrorNotice & blah\\
		StorageOpenErrorNotice & blah\\
		StorageWriteErrorNotice & blah\\
	\end{tabu}
\end{table}
