...
section. With a quick glance of the below diagram, we can see that ManageProjects actually covers a great many details including EditProject and CreateNewProject! Note that we 
denote error cases with an <<extend>> relationship.
