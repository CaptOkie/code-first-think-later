...
\begin{table}[H]
	...
	\begin{tabu} to \textwidth {l >{\bf}l X X[2.75]}
		...
		\begin{minipage}[t]{\linewidth}
			...
			\end{itemize}
		\end{minipage} & 
		A \textbf{Student} is a specific type of User that can create/edit their Profiles and join/leave existing Projects. Applies to \ucref{manage-enrollment}, \ucref{edit-profile} \\
		
		\cllabel{administrator}\clref{administrator} & Administrator & 
		&
		An \textbf{Administrator} is a specific type of user that can create/edit projects and run/view results of the PPID. Applies to \ucref{manage-project}, \ucref{create-new-project}, \ucref{launch-ppid}, \ucref{view-ppid-results}, \ucref{view-ppid-summary}, \ucref{view-ppid-details}, \ucref{edit-project-details} \\
		...
		\begin{minipage}[t]{\linewidth}
			...
			\end{itemize}
		\end{minipage} & 
		A \textbf{Project} contains a collection of Students that will get sorted into Groups. These are made and edited by the \textbf{Administrator}. Applies to \ucref{manage-enrollment}, \ucref{manage-project}, \ucref{create-new-project}, \ucref{launch-ppid}, \ucref{view-ppid-results}, \ucref{view-ppid-summary}, \ucref{view-ppid-details}, \ucref{edit-project-details} \\
		...
		\begin{minipage}[t]{\linewidth}
			...
			\end{itemize}
		\end{minipage} & 
		A \textbf{Profile} is a set of responses maintained by each Student. These values are the necessary input for the PPID algorithm to run. Applies to \ucref{edit-profile} \\
	\end{tabu}
\end{table}
