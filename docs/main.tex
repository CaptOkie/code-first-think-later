...
\begin{center}
	\begin{tabu} to \textwidth {>{\it}l X}
		...
		Exit Conditions &
        	\begin{minipage}[t]{\linewidth}
			\begin{itemize}
			    \item The Student is shown a menu.
	        \end{itemize}
		\end{minipage} \\
...
\begin{center}
	\begin{tabu} to \textwidth {>{\it}l X}
		...
		\begin{minipage}[t]{\linewidth}
		    \begin{enumerate}
			    \item[1.] The system brings up a menu of details to edit on the new project (include use case \textbf{EditProjectDetails}).
			    \item[2.] The system displays the new project to the Administrator.
			\end{enumerate}
	    \end{minipage} \\
...
\subsubsection*{Control and boundary objects for ManageProjects (\manageproject{})}

\begin{figure}[H]
	\centering{}
	\includegraphics[scale=0.4]{imgs/cbod/manage-projects.png}
	\caption{Control/Boundary Objects for ManageProjects}
\end{figure}
