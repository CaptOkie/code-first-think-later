...
\newcommand{\smref}[1]{\textbf{SM-\ref{sm:#1}}}
...
\newcommand{\seqref}[1]{\textbf{SQ-\ref{seq:#1}}}
...
\begin{tabu} to \textwidth {>{\bf}l X[2]}
		\tableheader{}Control Object & Definition\\
		StorageReadErrorControl & 
			The {\bf StorageReadErrorControl} object manages the StorageReadError use case. The object is created when any user makes a request to read a file from the Storage and the
			read operation fails. It then displays a notice, StorageReadErrorNotice, to the user.\\
		StorageOpenControl & 
			The {\bf StorageOpenControl} object manages...\\
		StorageOpenErrorControl & 
			The {\bf StorageOpenErrorControl} object manages the StorageOpenError use case. The object is created when any user makes a request to open the Storage and the operation
			fails. It then displays a notice, StorageOpenErrorNotice, to the user.\\
		StorageWriteControl & 
			The {\bf StorageWriteControl} object manages...\\
		StorageWriteErrorControl & 
			The {\bf StorageWriteErrorControl} object manage the StorageWriteError use case. The object is created when any user makes a write to the Storage request and the operation
			fails. It then displays a notice, StorageWriteErrorNotice, to the user.\\
\end{tabu}
\end{center}
...
\begin{figure}[H]
	...
	\caption{State Machine for User/Student/Administrator Log in (\smref{user-log-in})}
...
\begin{figure}[H]
	...
	\caption{State Machine for Student Join Project (\smref{student-join-project})}
...
\begin{figure}[H]
	...
	\caption{State Machine for Student Leave Project (\smref{student-leave-project})}
...
\begin{figure}[H]
	...
	\caption{State Machine for Profile Details (\smref{profile-details})}
...
\begin{figure}[H]
	...
	\caption{State Machine for Project Student Enrollment (\smref{project-student-enrollment})}
...
\begin{figure}[H]
	...
	\caption{State Machine for Project Name (\smref{project-name})}
...
\begin{figure}[H]
	...
	\caption{State Machine for Project PPID Results (\smref{project-ppid-results})}
...
\begin{figure}[H]
	...
	\caption{State Machine for Group Enrollment (\smref{group-enrollment})}
...
\begin{figure}[H]
	...
	\caption{State Machine for GroupSize Value (\smref{group-size-value})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for ManageEnrollment (\seqref{manage-enrollment})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for EditProfile (\seqref{edit-profile})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for ManageProject (\seqref{manage-project})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for CreateNewProject (\seqref{create-new-project})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for LaunchPPID (\seqref{launch-ppid})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for InsufficientStudentsError (\seqref{insufficient-students-error})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for ViewPPIDResults (\seqref{view-ppid-results})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for ViewPPIDSummary (\seqref{view-ppid-summary})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for ViewPPIDDetails (\seqref{view-ppid-details})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for EditProjectDetails (\seqref{edit-project-details})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for EditProject (\seqref{edit-project})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for JoinProject (\seqref{join-project})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for LeaveProject (\seqref{leave-project})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for EditPersonalValues (\seqref{edit-personal-values})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for EditDesiredValues (\seqref{edit-desired-values})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for InvalidInputError (\seqref{invalid-input-error})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for EditProjectName (\seqref{edit-project-name})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for ProjectExistsError (\seqref{project-exists-error})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for EditGroupSize (\seqref{edit-group-size})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for InvalidGroupSizeError (\seqref{invalid-group-size-error})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for StorageError (\seqref{storage-error})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for StorageReadError (\seqref{storage-read-error})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for StorageOpenError (\seqref{storage-open-error})}
...
\begin{figure}[H]
	...
	\caption{Sequence Diagram for StorageWriteError (\seqref{storage-write-error})}
