	...
	\begin{tabu} to \textwidth {>{\it}l X}
	    ...
	    \begin{enumerate}[topsep=-1em,leftmargin=*]
			...
			\begin{enumerate}
				...
				\item[3.] If the Student chooses to edit their profile, the system modified. The Student may choose to edit their personal details (include use case \textbf{EditPersonalValues}) or to edit their desired partner values (include use case \textbf{EditDesiredValues}).
