...
\item Students can view a list of existing projects.
\item Students can add themselves to any number of projects.
\item Students can remove themselves from a project.
\item Students can edit their project partner profile.
\begin{enumerate}[-1]
\item 
\end{enumerate}
\item Students can view their project partner profile.
\item Administrators can create projects.
\item Administrators can edit projects.
\item Administrators can modify PPID configuration values.
\begin{enumerate}[-1]
\item Adjust team size.
\end{enumerate}
\item Administrators can launch the PPID algorithm for a specific program.
\item Administrators can add students to a project.
\item Administrators can remove students from a project.
\end{enumerate}
